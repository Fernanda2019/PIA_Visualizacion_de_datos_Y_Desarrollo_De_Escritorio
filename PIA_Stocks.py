...
#esta importacion no spermite manipular y usar imagenes
from PIL import ImageTk,Image
#Nos permite usar mensajes
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        #Creamos una funcion que mostrara los mensajes correcpondientes a los botones 
        def mesagge():
        ...
        class Menu:
            def Ingresar_db(self):
                conexioon=sqlite3.connect("Inventario.db")
                return conexion
            ...
            def update_data(self):
                ...
                if (usuario == "Administrador"):
                    ...
                    mb.showinfo("Operacion invalida", "Opciones disponibles solo\npara el administrador")
                    #El metodo commit nos permite guardar los cambios 
                    con.commit()
                    self.fetch_data()
                    self.clear()
